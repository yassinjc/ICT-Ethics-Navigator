...
// Handles the logic for Question 2 of the Autonomy Quiz
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  continueButton.addEventListener("click", () => {
    window.location.href = "quiz-q3-autonomy.html";
  });
});